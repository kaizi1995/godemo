...
var (
	...
	GUID_DEVINTERFACE_USB_HUB = GUID{0xf18a0e88, 0xc30c, 0x11d0, [8]byte{0x88, 0x15, 0x00, 0xa0, 0xc9, 0x06, 0xbe, 0xd8}}

	GUID_DEVINTERFACE_USB_DEVICE = GUID{0xA5DCBF10, 0x6530, 0x11D2, [8]byte{0x90, 0x1F, 0x00, 0xC0, 0x4F, 0xB9, 0x51, 0xED}}

	GUID_DEVINTERFACE_USB_HOST_CONTROLLER = GUID{0x3abf6f2d, 0x71c4, 0x462a, [8]byte{0x8a, 0x92, 0x1e, 0x68, 0x61, 0xe6, 0xaf, 0x27}}

	GUID_USB_WMI_STD_DATA = GUID{0x4e623b20, 0xcb14, 0x11d1, [8]byte{0xb3, 0x31, 0x00, 0xa0, 0xc9, 0x59, 0xbb, 0xd2}}

	GUID_USB_WMI_STD_NOTIFICATION = GUID_USB_WMI_STD_DATA

	GUID_USB_WMI_DEVICE_PERF_INFO = GUID{0x66c1aa3c, 0x499f, 0x49a0, [8]byte{0xa9, 0xa5, 0x61, 0xe2, 0x35, 0x9f, 0x64, 0x7}}

	GUID_USB_WMI_NODE_INFO = GUID{0x9c179357, 0xdc7a, 0x4f41, [8]byte{0xb6, 0x6b, 0x32, 0x3b, 0x9d, 0xdc, 0xb5, 0xb1}}

	GUID_USB_WMI_TRACING = GUID{0x3a61881b, 0xb4e6, 0x4bf9, [8]byte{0xae, 0xf, 0x3c, 0xd8, 0xf3, 0x94, 0xe5, 0x2f}}

	GUID_USB_TRANSFER_TRACING = GUID{0x681eb8aa, 0x403d, 0x452c, [8]byte{0x9f, 0x8a, 0xf0, 0x61, 0x6f, 0xac, 0x95, 0x40}}

	GUID_USB_PERFORMANCE_TRACING = GUID{0xd5de77a6, 0x6ae9, 0x425c, [8]byte{0xb1, 0xe2, 0xf5, 0x61, 0x5f, 0xd3, 0x48, 0xa9}}

	GUID_USB_WMI_SURPRISE_REMOVAL_NOTIFICATION = GUID{0x9bbbf831, 0xa2f2, 0x43b4, [8]byte{0x96, 0xd1, 0x86, 0x94, 0x4b, 0x59, 0x14, 0xb3}}

	GUID_DEVINTERFACE_DISK = GUID{0x53f56307, 0xb6bf, 0x11d0, [8]byte{0x94, 0xf2, 0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b}}

	GUID_DEVINTERFACE_HID = GUID{0x4D1E55B2, 0xF16F, 0x11CF, [8]byte{0x88, 0xCB, 0x00, 0x11, 0x11, 0x00, 0x00, 0x30}}

	GUID_NDIS_LAN_CLASS = GUID{0xad498944, 0x762f, 0x11d0, [8]byte{0x8d, 0xcb, 0x00, 0xc0, 0x4f, 0xc3, 0x35, 0x8c}}

	GUID_DEVINTERFACE_COMPORT = GUID{0x86e0d1e0, 0x8089, 0x11d0, [8]byte{0x9c, 0xe4, 0x08, 0x00, 0x3e, 0x30, 0x1f, 0x73}}

	GUID_DEVINTERFACE_PARALLEL = GUID{0x97F76EF0, 0xF883, 0x11D0, [8]byte{0xAF, 0x1F, 0x00, 0x00, 0xF8, 0x00, 0x84, 0x5C}}

	GUID_DEVINTERFACE_PARCLASS = GUID{0x811FC6A5, 0xF728, 0x11D0, [8]byte{0xA5, 0x37, 0x00, 0x00, 0xF8, 0x75, 0x3E, 0xD1}}

	GUID_DEVINTERFACE_SERENUM_BUS_ENUMERATOR = GUID{0x4D36E978, 0xE325, 0x11CE, [8]byte{0xBF, 0xC1, 0x08, 0x00, 0x2B, 0xE1, 0x03, 0x18}}
